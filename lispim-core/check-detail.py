...
for i, line in enumerate(lines, 1):
    if 2195 <= i <= 2210:
        ...
        print(f'{i:5d}: depth change: {net:+d} (open={open_count}, close={close_count}) | {line[:70]}')

  ...
  return (
    <div className="h-screen flex flex-col bg-gray-900">
      ...
      <div className="flex-1 overflow-y-auto">
        {/* General Settings */}
        <div className="bg-gray-800 mt-2 divide-y divide-gray-700">
          <div className="text-xs text-gray-500 px-4 py-2 bg-gray-800/50">通用</div>
          ...
          <div className="flex items-center justify-between px-4 py-3 hover:bg-gray-700 cursor-pointer">
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-300">新消息通知</span>
            </div>
          ...
          <div className="flex items-center justify-between px-4 py-3 hover:bg-gray-700 cursor-pointer">
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-300">消息免打扰</span>
            </div>
            <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
        ...
        {/* Privacy Settings */}
        <div className="bg-gray-800 mt-2 divide-y divide-gray-700">
          <div className="text-xs text-gray-500 px-4 py-2 bg-gray-800/50">隐私</div>
          ...
          <div className="flex items-center justify-between px-4 py-3 hover:bg-gray-700 cursor-pointer">
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-300">隐私设置</span>
            </div>
            <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
          ...
          <div className="flex items-center justify-between px-4 py-3 hover:bg-gray-700 cursor-pointer">
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-300">屏蔽联系人</span>
            </div>
            <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
        ...
        {/* About */}
        <div className="bg-gray-800 mt-2 divide-y divide-gray-700">
          <div className="text-xs text-gray-500 px-4 py-2 bg-gray-800/50">关于</div>

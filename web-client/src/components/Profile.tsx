  ...
  return (
    <div className="h-screen flex flex-col bg-gray-900">
      ...
      <div className="bg-gray-800 p-6 mb-2">
        <div className="flex items-center gap-4" onClick={() => navigate('/profile/detail')}>
          <div className="w-20 h-20 rounded-full bg-blue-500 flex items-center justify-center text-white text-2xl font-medium cursor-pointer">
            {user?.avatar ? (
              <img src={user.avatar} alt={user.displayName} className="w-20 h-20 rounded-full object-cover" />
            ) : (
